...
%package staticdev
Summary: staticdev components for the pcsc-lite package.
Group: Default
Requires: pcsc-lite-dev = %{version}-%{release}

%description staticdev
staticdev components for the pcsc-lite package.
