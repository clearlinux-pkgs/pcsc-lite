...
Source0  : https://pcsclite.apdu.fr/files/pcsc-lite-2.2.1.tar.xz
Source1  : https://pcsclite.apdu.fr/files/pcsc-lite-2.2.1.tar.xz.asc
...
%setup -q -n pcsc-lite-2.2.1
cd %{_builddir}/pcsc-lite-2.2.1
pushd ..
cp -a pcsc-lite-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715196278
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsystemdunit=system  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsystemdunit=system  builddiravx2
