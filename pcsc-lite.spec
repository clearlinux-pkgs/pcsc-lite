...
Source0  : https://pcsclite.apdu.fr/files/pcsc-lite-1.9.6.tar.bz2
Source1  : https://pcsclite.apdu.fr/files/pcsc-lite-1.9.6.tar.bz2.asc
...
%prep
%setup -q -n pcsc-lite-1.9.6
cd %{_builddir}/pcsc-lite-1.9.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652320085
...
cp %{_builddir}/pcsc-lite-1.9.6/COPYING %{buildroot}/usr/share/package-licenses/pcsc-lite/12f0c48a0be5fb271ccd2f1de671e747c511166f
%make_install
